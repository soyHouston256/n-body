...
def generate_snapshot():
    ...
    plt.savefig("../visualizations/simulation_snapshot.png", dpi=300, bbox_inches='tight', facecolor='black')
    print("Snapshot saved to ../visualizations/simulation_snapshot.png")
